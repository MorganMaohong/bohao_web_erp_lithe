...
function toLayout() {
  ...
  const redirectPath = typeof r === 'string' && r !== '/' ? r : userStore.homePath || '/dashboard'
  ...
  >
    ...
    <div class="relative z-50 flex h-[480px] w-[800px] justify-center rounded shadow-lg">
      ...
      >
        ...
        <div>
          <div>
            <h2 class="text-2xl">博灏智慧 ERP</h2>
            <p class="text-neutral-400 transition-[color] dark:text-neutral-500">
          ...
          <div class="mt-12">
            ...
            >
              ...
              <div class="flex justify-between">
                <NCheckbox v-model:checked="signInForm.check">30 天内免登录</NCheckbox>
                <NButton
                  text
                  size="small"
                >
